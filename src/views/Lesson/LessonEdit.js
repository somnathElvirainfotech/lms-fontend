                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <select required className="form-control" id="exampleFormControlSelect1" onChange={handleChange} name="chapter_id" value={inputs.chapter_id}>
                                                    <option value='' > -- Select chapter -- </option>
                                                    {chapter.length && chapter.map((item) => (<option value={item.id}>{item.chapter_name.toUpperCase()}</option>))}
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div className="form-row">
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input required type="text" className="form-control" name="lesson_name" value={inputs.lesson_name}
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input type="file" name="lesson_file" className="form-control" value={inputs.lesson_file}
                                    ...
                                    <div className="form-row">
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input required type="number" className="form-control" name="lesson_no" value={inputs.lesson_no}
                                                    onChange={handleChange} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                <select required className="form-control" id="lesson_vedio_type" onChange={handleChange} name="lesson_vedio_type" value={inputs.lesson_vedio_type}>
                                    ...
                                    <div className="form-row" >
                                        ...
                                        {chkVedio == "video" &&
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <input type="file" name="lesson_vedio" className="form-control" value={inputs.lesson_vedio}
                                                        onChange={VedioHandler} accept="video/mp4,video/x-m4v,video/*" />
                                                </div>
                                            </div>}
                                        ...
                                        {chkVedio == "link" &&
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <input required type="text" name="lesson_vedio_link" className="form-control" value={inputs.lesson_vedio_link}
                                                        onChange={handleChange} />
                                                </div>
                                            </div>
                                        }
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-group">
                                                ...
                                                {showvedio && chkVedio == "video" && <div>

                                                    <ReactPlayer url={showvedio} width="420px" height="240px" playing="true" controls="true" ></ReactPlayer>

                                                </div>}

                                                {chkVedio == "link" && linkVedio &&
                                                    <ReactPlayer url={linkVedio} width="420px" height="240px" playing="true" controls="true" ></ReactPlayer>
                                                }
