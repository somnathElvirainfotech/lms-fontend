    ...
    const FormSubmit = async (e) => {
        ...
        try {
            ...
            if (!Number.isInteger(Number(inputs.lesson_no))) {
                ...
                data.append("lesson_file", isEmpty(attachment_file) ? '' : attachment_file)
                                        ...
                                        {chkVedio == "video" &&
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <input required type="file" name="lesson_vedio" className="form-control" value={inputs.lesson_vedio}
