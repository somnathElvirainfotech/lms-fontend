            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-12 col-sm-6 pr-md-0">
                        <div className="container">
                            <h2>User Add <span><button type="button" className="sec-btn" onClick={previousPage}>Back</button></span></h2>
                                    ...
                                    <form id="myForm" enctype="multipart/form-data" method="post" onSubmit={FormSubmit}>
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    <label>EMAIL</label>
                                                    <input required type="email" className="form-control" name="email" value={cinputs.email}
                                                        onChange={handleChange} />
                                                </div>
                                            </div>
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <select required className="form-control" id="exampleFormControlSelect1" onChange={handleChange} name="role" value={cinputs.role}>
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <input required type="text" className="form-control" name="password1" value={cinputs.password1}
                                                        onChange={handleChange} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <input required type="text" className="form-control" name="password2" value={cinputs.password2}
                                                        onChange={handleChange} />
                                                </div>
                                            </div>
